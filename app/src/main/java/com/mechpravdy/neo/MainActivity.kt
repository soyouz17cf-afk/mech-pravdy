...
🔹 ЛОКАЛЬНЫЙ РЕЖИМ:
  ...
  Когда скачаются — нажми ещё раз.
    ...
    private fun switchToLocal() {
        ...
        // Если частей нет — начинаем загрузку по твоим ссылкам
